...
class TestCheckResponseRange:
    ...
    def test_flag_invalid_responses(self):
        ...
        assert invalid_mask.iloc[3] == True  # 7 is invalid
    ...
    def test_handle_existing_nan(self):
        ...
        assert result['satisfaction_valid'].iloc[1] == True  # NaN is valid
    ...
    def test_float_range(self):
        ...
        assert invalid_mask.iloc[2] == True  # 5.2 is invalid
...
class TestFlagStraightLiners:
    ...
    def test_detect_straight_liner(self):
        ...
        assert result.iloc[0] == True  # All 3s
        assert result.iloc[1] == False  # Varied responses
        assert result.iloc[2] == True  # All 3s - straight-liner
    ...
    def test_with_missing_values(self):
        ...
        assert result.iloc[0] == True  # All 3s
        assert result.iloc[2] == True  # All 5s
    ...
    def test_threshold_parameter(self):
        ...
        assert result_0.iloc[0] == True  # All 1s
        assert result_0.iloc[1] == True  # All 2s
        assert result_0.iloc[2] == False  # Has 3 unique values
...
class TestDetectSpeeders:
    ...
    def test_detect_with_manual_threshold(self):
        ...
        assert result.iloc[1] == True  # 45 < 60
        assert result.iloc[3] == True  # 30 < 60
        assert result.iloc[0] == False  # 120 >= 60
    ...
    def test_iqr_method(self):
        ...
        assert result.iloc[5] == True  # 30 is outlier
    ...
    def test_median_method(self):
        ...
        assert result.iloc[3] == True  # 40 < 75
...
class TestCheckLogicalConsistency:
    ...
    def test_basic_consistency_check(self):
        ...
        assert result['consistent_age_experience'].iloc[0] == True  # 25 >= 5+18 (23)
        assert result['consistent_age_experience'].iloc[1] == True  # 30 >= 12+18 (30)
        assert result['consistent_age_experience'].iloc[2] == True  # 20 >= 2+18 (20)
    ...
    def test_multiple_rules(self):
        ...
        assert result['consistent_min_max'].iloc[0] == True
        assert result['consistent_min_max'].iloc[1] == False
